    ...
    <div className="flex flex-col items-center gap-y-5">
      <svg width="147.049" height="121.639">
        <g data-name="Group 107">
          ...
          <path
            data-name="Path 590"
            d="M108.473 41.035s-7.777 7.622-4.511 8.555 7-7 7-7z"
            fill="#ffb9b9"
          ></path>
          <path
            data-name="Path 591"
            d="M116.25 66.701l-.933 4.355 7 .311-1.089-4.667z"
            fill="#ffb9b9"
          ></path>
          <path
            data-name="Path 592"
            d="M138.338 93.611l-.933 4.355 7 .311-1.089-4.667z"
            fill="#ffb9b9"
          ></path>
          <path
            data-name="Path 593"
      ...
      <p className="font-bold text-xl">Wait Loading</p>
